...
while running:
    ...
    draw_button("Play vs Player", 200, 150, 250, 60, BUTTON_COLOR, HOVER_COLOR, run_connect4_no_ai)
    draw_button("Play vs AI", 200, 250, 250, 60, BUTTON_COLOR, HOVER_COLOR, run_connect4_ai)
